...
public sealed class HookForwarderTests
{
    ...
    public async Task ValidPayloadReachesPipeAndStdoutIsNoOp()
    {
        ...
        Assert.Equal(1, root.GetProperty("ingressVersion").GetInt32());
...
public sealed class ReplayTests
{
    ...
    [Fact]
    public async Task ReplayLoaderSkipsNonHookJsonAndReturnsChronologicalObservations()
    {
